...
Graficzny klient FTP dla KDE z możliwością jednoczesnego łączenia z
wieloma serwerami. KBear pozwala kopiować/przenosić pliki lub foldery
między serwerami przez drag-and-drop lub wytnij-wklej. Ma też bazę
danych o serwerach.
